...
//            sprintf(buff,"%s,%s,%s",String(ypr[0]*180/M_PI,2).c_str(),String(ypr[1]*180/M_PI,2).c_str(),String(ypr[2]*180/M_PI,2).c_str());
//            Serial1.println(buff);
            //Serial1.print(String(ypr[0]*180/M_PI)+","+String(ypr[1]*180/M_PI)+","+String(ypr[2]*180/M_PI));
//            dtostrf(f, 2, 2, &str[strlen(str)]);
            //Serial1.print(ypr[0]*180/M_PI,",",ypr[1]*180/M_PI,",",ypr[2]*180/M_PI);
//            String dat= String(ypr[0]*180/M_PI) + "," + String(ypr[1]*180/M_PI) + "," + String(ypr[3]*180/M_PI); 
...
//            serializeJson(doc,Serial1);
            ...
            int16_t r = (int16_t) encoderPosition;
            byte buf[8];
            buf[0] = x & 255;
            buf[1] = (x >> 8) & 255;
            buf[2] = y & 255;
